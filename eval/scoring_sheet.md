...
|----|--------------------------------|
| Q-01 | What proportion of the decline in retailer forecourts was caused by business closures or market conditions, and what proportion wa… |
| Q-02 | How much additional ARPR growth can be delivered through price increases before customer churn or reduced package uptake outweighs… |
| Q-03 | What incremental revenue, retention or conversion benefit does Deal Builder generate per retailer, and how does this compare with … |
| Q-04 | Why did cross-platform minutes decline despite stable visits, and what happened to enquiries, conversion rates and revenue per vis… |
| Q-05 | What operating or market scenarios would cause management to reduce or pause the planned c.£500m FY2027 share-buyback programme? |
| Q-06 | If consumers increasingly begin vehicle searches through AI agents, how will Auto Trader preserve direct customer relationships an… |
| Q-07 | Which datasets are truly exclusive to Auto Trader, and how difficult would it be for competitors, manufacturers, lenders or large … |
| Q-08 | Management states that high-intent leads convert at roughly twice the average rate — is this based on controlled testing, and does… |
| Q-09 | What were the primary causes of the decline in employee engagement from 91% to 72%, and what indicators will management use to est… |
| Q-10 | What financial, operational or product changes could arise from the CMA investigation into online reviews, and are any revenue str… |
